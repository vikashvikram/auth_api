...
This project rocks and uses MIT-LICENSE. Its provides restful api for registration and authentication of users. Respon is JSON only. This engine supposed to support you backend application by providing authentication mechanism.

===SETUP

#config/routes.rb
mount AuthApi::Engine => "/your_path"
